...
class CriteriaFactory {
    ...
    def criteriaFactoryMap =
        [
                ...
                "diagnostic_study_performed": { json, measurementPeriod, measureJson -> new Lab(measureJson:measureJson, json:json, valueSetCodeResolver:valueSetCodeResolver, measurementPeriod:measurementPeriod) },
