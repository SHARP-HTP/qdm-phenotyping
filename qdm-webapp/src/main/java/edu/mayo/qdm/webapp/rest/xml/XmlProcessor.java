...
public class XmlProcessor {
	 ...
	 * @return the string
	 */
	public String executionsToXml(Executions executions){
		return this.xstream.toXML(executions);
	}
	 ...
	 * @return the string
	 */
	public String executionToXml(ExecutionInfo execution) {
		return this.xstream.toXML(execution);
	}
}
